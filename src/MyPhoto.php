...
<body>
    ...
    <div class="my-container">
        <div class="my-box">
            ...
            <div class="my-photo-box shadowed">
                <div class="my-img-box">
                    <a href="Detail.php">
                        <img src="../img/normal/medium/6114867983.jpg" alt="收藏图片" />
                    </a>
                </div>
                ...
                <div class="my-description-box">
                    ...
                    <div class="my-btn-box">
                        <div class="modify-btn" name="modify_btn_1" onclick="window.location.href='Upload.html'">修改</div>
            ...
            <div class="my-photo-box shadowed">
                <div class="my-img-box">
                    <a href="Detail.php">
                        <img src="../img/normal/medium/9494464567.jpg" alt="收藏图片" />
                    </a>
                </div>
            ...
            <div class="my-photo-box shadowed">
                <div class="my-img-box">
                    <a href="Detail.php">
                        <img src="../img/normal/medium/6115603234.jpg" alt="收藏图片" />
                    </a>
                </div>
